...
void LaneDetectionComponent::OnReceiveImage(
  ...
  apollo::perf::AppendPoint("perception.lane_detection.tick",
                            trace_id, t0);
  ...
  const uint64_t ts0 = apollo::perf::NowNs();
  apollo::perf::AppendPoint("perception.lane_detection.check_timestamp",
                            trace_id, ts0);
  ...
  apollo::perf::AppendLatency("perception.lane_detection.internal_proc",
                              trace_id, p0, p1);
  ...
  const uint64_t ts1 = apollo::perf::NowNs();
  apollo::perf::AppendPoint("perception.lane_detection.end_stats",
                            trace_id, ts1);
}
