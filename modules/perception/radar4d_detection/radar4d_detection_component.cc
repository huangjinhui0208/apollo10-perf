...
bool Radar4dDetectionComponent::Proc(
  ...
  apollo::perf::AppendPoint("perception.radar4d_detection.tick",
                            trace_id, t0);
  ...
  apollo::perf::AppendLatency("perception.radar4d_detection.proc",
                              trace_id, t1, t2);
  ...
  if (status) {
    ...
    apollo::perf::AppendLatency("perception.radar4d_detection.write",
                                trace_id, w0, w1);
    apollo::perf::AppendLatency("perception.radar4d_detection.total",
                                trace_id, t0, w1);
  }
  return status;
}
...
bool Radar4dDetectionComponent::InternalProc(
  ...
  apollo::perf::AppendLatency("perception.radar4d_detection.get_tf",
                              trace_id, tf0, tf1);
  ...
  apollo::perf::AppendLatency("perception.radar4d_detection.get_car_speed",
                              trace_id, s0, s1);
  ...
  apollo::perf::AppendLatency("perception.radar4d_detection.get_roi",
                              trace_id, r0, r1);
  ...
  apollo::perf::AppendLatency("perception.radar4d_detection.preprocessor",
                              trace_id, p0, p1);
  ...
  apollo::perf::AppendLatency("perception.radar4d_detection.perception",
                              trace_id, pr0, pr1);
