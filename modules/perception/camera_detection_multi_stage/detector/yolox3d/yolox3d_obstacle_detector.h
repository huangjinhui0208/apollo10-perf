...
class Yolox3DObstacleDetector : public BaseObstacleDetector {
 ...
 private:
  ...
  cudaEvent_t infer2d_event_start_ = nullptr;
  cudaEvent_t infer2d_event_stop_ = nullptr;

  cudaEvent_t infer3d_event_start_ = nullptr;
  cudaEvent_t infer3d_event_stop_ = nullptr;
#endif

  bool gpu_profile_enabled_ = true;
  bool gpu_event_ready_ = false;
  uint64_t detect_call_idx_ = 0;
  uint32_t gpu_profile_warmup_frames_ = 1;
